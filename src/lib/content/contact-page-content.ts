...
const fallbackContent: ContactPageSettingsContent = {
  ...
  whatsappCardDescription: "Hubungi tim Kembung via WhatsApp untuk pertanyaan produk, kerja sama, atau bantuan order.",
  addressLabel: "Alamat",
  address: "Jl. Lodan Raya No. 2\nAncol, Jakarta Utara, DKI Jakarta",
  phoneLabel: "Nomor Telepon",
  phoneNumber: "+62 812-3456-7890",
  emailLabel: "Email",
  emailAddress: "hello@kembung.store",
  websiteLabel: "Website",
  websiteUrl: "https://kembung.store",
  websiteText: "Kembung Official Website",
  socialMediaLabel: "Social Media",
  studioMapImageUrl: "/ancol.jpg",
  instagramHandle: "@kembung.id",
  instagramUrl: "#",
  tiktokHandle: "@kembung.id",
  tiktokUrl: "#",
  ...
  formDescription: "Isi form berikut dan tim Kembung akan segera menghubungi kamu.",
  closingStatement:
